...
internal static partial class Native
{
    ...
    [DllImport(Library, CallingConvention = CallingConvention.Cdecl)] internal static extern int gua_register_world_object_v2(nint context, in GuaNativeWorldObjectDescriptorV2 descriptor);
